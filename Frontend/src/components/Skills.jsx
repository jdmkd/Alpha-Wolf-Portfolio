...
const Skills = () => {
  ...
  return (
    <Section
      id="features"
      className="lg:mb-[0rem] bg-black opacity-[1] z-0"
      // crossesOffset=" lg:translate-y-[0.25rem]"
      crosses
    >
      <div className="container relative z-2">
        <Heading
          className="md:max-w-md h1 font-bold lg:max-w-2xl"
          title="Tech Skills"
        />
        ...
        <div className=" mb-20 ">
          <div
            ref={boxRef}
            className="relative grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-6 w-full mb-6 content-center items-center px-[2rem] py-[2rem] bg-gray-900 bg-transparent border-transparent opacity-[10] border-[1px] border-gray-800 rounded-[10px]"
          >
